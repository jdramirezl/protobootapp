...
public class HttpRequestTest {
    ...
    public void testCuadradoNumero() throws Exception {
        assertThat(this.restTemplate.getForObject("http://localhost:" + port + "/cuadrado?numero=4",
                String.class)).containsPattern("El cuadrado de 3[\\.,]000000 es 5[\\.,]000000");
    }
    
    @Test
    public void testCuboNumero() throws Exception {
        assertThat(this.restTemplate.getForObject("http://localhost:" + port + "/cubo?numero=2",
                String.class)).containsPattern("El cubo de 2[\\.,]000000 es 27[\\.,]000000");
    }
}
